...
* a0=clip_crds_in: a1=clip_crds_out: a2=clip_no_out: a3=saved(clip_crds_out):
...
.clip_ymin:
	...
	move.w	(a0)+,d5        ;ist x
	move.w	(a0)+,d6        ;1st y
	move.w	clip_ymin,d0     ;this limit
...
.clip_end:
	lea	clip_crds_in,a0
	move.l	a0,clip_coords_lst
	rts

.clip_ld1:
	lea	clip_crds_in,a0      ;pointer to vertex coords before
	lea	clip_crds_out,a1     ;and after this clip
	move.l	a1,a3           ;saved
	move.w	clip_no_in,d7        ;this many sides before
	lea	clip_no_out,a2       ;where the number after is stored
	clr.w	clip_no_out
	rts

.clip_ld2:
	lea	clip_crds_out,a0     ;pointer to vertex coords before
	lea	clip_crds_in,a1      ;and after this clip
	move.l	a1,a3           ;saved
	move.w	clip_no_out,d7       ;this many sides before
	lea	clip_no_in,a2        ;where the number after is stored
	clr.w	clip_no_in
	rts
...
.xint_out:
	rts	                ;next vertex
        ...
        ; the number of polygon sides at clip_no_in

; Polygon attributes
clip_crds_in:		ds.w	100	;input coords
clip_crds_out:      	ds.w	100     ;output as above
clip_no_out:        	ds.w	1       ;output number
clip_no_in:         	ds.w	1       ;output number
clip_xmax:		ds.w	1       ;clip frame limits
clip_xmin:      	ds.w	1
clip_ymin:      	ds.w	1
clip_ymax:      	ds.w	1
clip_coords_lst:	ds.l	1
